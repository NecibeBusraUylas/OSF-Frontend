...
(function () {
  let dots = document.querySelectorAll(
    "section.slider .slider-dots ul.dots li button"
  );

  let dotsScreens = document.querySelectorAll(
    "section.slider .slider-dots div.img"
  );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let arrows = document.querySelectorAll(
    "section.feat-prod .slider-arrows .arrows button"
  );
  ...
  arrows[1].addEventListener("click", () => {
    ...
    const arrowBox = document.querySelector(
      "section.feat-prod div.slider-arrows div.items"
    );
...
(function () {
  const buyNow = document.querySelector(
    "section.pop-items div.items div.item div.paired button"
  );
...
function makeFutureSlider() {
  ...
  if (window.innerWidth <= 440 && futureDots === null) {
    ...
    const futureDotsBox = document.querySelector(
      "section.pop-items ul.future-dots"
    );

    // Find first 5 items
    let futureItems = document.querySelectorAll(
      "section.pop-items div.items div.item:nth-child(-n+5)"
    );
    ...
    futureDots = document.querySelectorAll(
      "section.pop-items ul.future-dots > li"
    );
